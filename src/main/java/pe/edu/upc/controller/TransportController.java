...
public class TransportController {
	...
	public String delete(Map<String, Object> model, @PathVariable(value = "id") Long id,RedirectAttributes objRedir) {
		try {
			if (id != null && id > 0) {
				tS.delete(id);
				objRedir.addFlashAttribute("mensaje", "Se eliminó correctamente");
